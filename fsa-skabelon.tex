...
\newcommand{\eksamensfooter}{%
  \lfoot{\elevnavn \linebreak Hummeltofteskolen \skoleklasse}
  \cfoot{\eksamensdato \linebreak side~\thepage~af~\pageref*{LastPage}}
  \rfoot{\proevefag \linebreak Elevnummer \elevnummer}
