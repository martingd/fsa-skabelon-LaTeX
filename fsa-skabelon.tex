...
% Handle svg vector graphics.
\usepackage{svg}

% Handle raster graphics (e.g. PNG).
\usepackage{graphicx}
...
Man kan inkludere billeder i SVG vektorgrafik eller fx PNG billeder.

\begin{figure}[htp]
  \centering
  \includegraphics[width=5cm]{Enhedscirklen.png}
  \caption{Enhedscirklen i PNG (300 dpi)}
  \label{figure:enhedscirklenpng300}
\end{figure}
...
\begin{figure}[htp]
  \centering
  \includegraphics[width=5cm]{Enhedscirklen.eps}
  \caption{Enhedscirklen i EPS}
  \label{figure:enhedscirkleneps}
\end{figure}
